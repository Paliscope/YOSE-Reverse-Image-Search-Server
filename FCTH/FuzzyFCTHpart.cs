...
namespace FCTH_Descriptor
{
    class FuzzyFCTHpart
    {
        ...
        public  double[] HorizontalMembershipValues = new double[8] { 0,0,20, 90, 
               20,90,255, 255};

        public  double[] VerticalMembershipValues = new double[8] { 0,0,20, 90, 
               20,90,255, 255};

        public  double[] EnergyMembershipValues = new double[8] { 0,0,20, 80, 
               20,80,255, 255};
        ...
        public  int[,] RulesDefinition = new int[8, 4]{
            {0,0,0,0},                          
            {0,0,1,1},                          
            {0,1,0,2},                          
            {0,1,1,3},                          
